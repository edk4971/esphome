...
- **ESPHome Core**: [Internal logic references.] (https://github.com/esphome/esphome/tree/dev/esphome/core)
    - stored in esphome\esphome\core
...
- **ESPHome Components**: [Internal logic references.] https://github.com/esphome/esphome/tree/dev/esphome/components
    - stored in esphome\esphome\components
...
- **ESPHome start-components**: https://github.com/esphome/starter-components
    - stored in esphome\examples\starter-components\components
    - Several exemplar external-components that demonstrate how to create an external_component
- **Espressif Demos**:
    - `esp-box` (`chatgpt_demo`): Verified the feasibility of direct API calls from ESP32. https://github.com/espressif/esp-box/tree/master/examples/chatgpt_demo - stored in esphome\examples\esp-box\examples\chatgpt_demo
    - `esp-webrtc-solution` (`openai_demo`): Evaluated WebRTC vs. WebSockets for real-time streaming. https://github.com/espressif/esp-webrtc-solution/tree/main/solutions/openai_demo - stored in esphome\examples\esp-webrtc-solution\solutions\openai_demo
    - LocalAI openai-realtime transports: https://localai.io/features/openai-realtime/#transports
    - ESPHome Code Standards: https://developers.esphome.io/contributing/code/ and https://github.com/esphome/esphome/blob/dev/AGENTS.md - stored at esphome\AGENTS.md
